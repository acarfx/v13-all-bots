...
let KıbrısACAR = [message.guild.emojiGöster("acar_pat"),message.guild.emojiGöster("acar_heart"),message.guild.emojiGöster("acar_vis")];
var SlotOne = KıbrısACAR[Math.floor(Math.random() * 3)]
var SlotTwo = KıbrısACAR[Math.floor(Math.random() * 3)]
var SlotThree = KıbrısACAR[Math.floor(Math.random() * 3)]
