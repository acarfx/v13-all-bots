...
module.exports = {
  ...
  onRequest: async function (client, message, args) {
    const emojis = [
        ...
        { name: "acar_pat", url: "https://static.wikia.nocookie.net/owobot/images/5/56/SlotsEggplant.png/revision/latest/scale-to-width-down/18?cb=20201231080844"},
        { name: "acar_heart", url: "https://static.wikia.nocookie.net/owobot/images/b/bb/SlotsHeart.png/revision/latest/scale-to-width-down/18?cb=20201231081114"},
        { name: "acar_vis", url: "https://static.wikia.nocookie.net/owobot/images/8/80/SlotsCherry.png/revision/latest/scale-to-width-down/20?cb=20201231081252"},
        { name: "acar_slot", url: "https://static.wikia.nocookie.net/owobot/images/f/f3/SlotsRolling.gif/revision/latest/scale-to-width-down/18?cb=20201231075644"},
        { name: "acar_cf", url: "https://cdn.discordapp.com/emojis/932325559051096084.gif?size=44&quality=lossless"},
        { name: "acar_cfwin", url: "https://cdn.discordapp.com/emojis/932326782223417455.png"},
        { name: "acar_cflose", url: "https://cdn.discordapp.com/emojis/932328417196671026.webp?size=44&quality=lossless"},
      ];
