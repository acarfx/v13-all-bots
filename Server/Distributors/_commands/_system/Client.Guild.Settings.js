  ...
  module.exports = {
    ...
    onRequest: async function (client, message, args) {
      ...
      const buttonSatir = new MessageActionRow().addComponents(
        ...
        .setOptions(
          {label: "Gerçekleşen Ayarlar", emoji: {id:"943285490617032755"}, description: "Yapılan (gerçekleşen) tüm ayar listesi bulunmaktadır.", value: "ayarlar"},
          {label: "Değiştirilebilir Ayarlar", emoji: {id: "943286195406925855"}, description: "Düzenlenmesi münkün olan ayarların listesi bulunmaktadır.", value: "ayarlistesi"},
          {label: "Güvenlik Sistemi", emoji: {id:"943285868368633886"}, description: "Sunucu üzerinde ki güvenliğin kontrolünü sağlayan ayarlar bulunmaktadır.", value: "ayarlar2"},
          {label: "Bot Düzenleme", emoji: {id: "925127916621291541"}, description: "Belirtilen botun profil resmi, isim ve hakkındasını düzenlenebilir.", value: "botsettings"},
          {label: "Yedekleme", emoji: {id:"949921900589617182"}, description: "Anlık sunucunun verilerini ve içeriklerini yedeklemektedir.", value: "ayarlar1"},
          {label: "Özel Komut Sistemi", emoji: {id: "951514358377234432"}, description: "Bot üzerinden komut oluşturarak, rol alıp/vermenize yarayan sistemdir.", value: "özelkomut"},
          {label: "Ekip Sistemi", emoji: {id: "938077389022437446"}, description: "Sunucu üzerinde istediğiniz kadar ekip oluşturabilir/silebilirsiniz.", value: "ekipcik"},
          {label: "Yasaklı Tag Sistemi", emoji: {id: "943290426562076762"}, description: "Sunucu üyelerinin isminde, istemediğiniz bir sembolü yasaklayabilir/kaldırabilirsiniz.", value: "yasaklıtag"},
          {label: "Rol & Seçenek Kurulumu", emoji: {id: "1040367310998872125"}, description: "Sunucu üzerinde olan menü ve düğme sistemini kurulumunu sağlar.", value: "seçenekkur"},
          {label: "Log Kurulumu", emoji: {id: "925127916382220379"}, description: "Sunucu da gerekli olan tüm işlem kayıtlarının kurulumu ve düzenlemesini sağlar.", value: "logkur"},
          {label: "Emoji Kurulumu", emoji: {id:"927315417146458113"}, description: "Botların ihtiyacı olan, emoji kurulumunu sağlar.", value: "emojikur"},
          {label: "Web Yönetim Paneli", emoji: {id: "949923926031601724"} ,description: "Botları ve sunucuyu tarayıcı üzerinden kontrol etmenizi sağlar.", value: "webpanel"},
          {label: "Süre & Ödeme İşlemleri", emoji: {id: "927189965677404170"} ,description: "Ödeme zamanı ve süre işlemlerini görüntüler.", value: "sure"},
          {label: "İstatistikleri Sıfırla", emoji: {id: "948674910425853993"}, description: "Sunucunun tüm genel ve haftalık istatistiklerini temizler.", value: "stattemizle"},
          {label: "Tüm Ayarları Sıfırla", emoji: {id: "927314290732576809"}, description: "Sunucunun tüm veritabanını ve yedeklerini kalıcı olarak temizler.", value: "ayarlar3"},
          {label: "Yeniden Başlat", emoji: {id: "927196659056791602"} ,description: "Tüm botları yeniden başlatmaktadır.", value: "restleaq"},
          ...
          {label: "Yedek Kur", emoji: {id:"938077389022437446"}, description: "Sunucu ayarlarının yedeklerini yüklemektedir.", value: "ayarlar62"},
          )
      )
      const ödeme = new MessageActionRow().addComponents(
        new MessageButton()
...
Size verilen dosyayı indirerek \`.setup\` komutunu kullanırken ek olarak eklendiğinde bu aldığınız yedeklemeyi tekrardan kurabileceksiniz.`, ephemeral: true})
                    ...
                    if (i.values[0] === 'ayarlar') {
                      ...
                      x.delete().catch(err => {})
                      let ayarlist = await message.channel.send({embeds: [new genEmbed().setColor("WHITE").setDescription(`:tada: Aşağıda ki ayarlar kategorisinden hangi yapılan ayar listesini görüntülemek istediğini seçerek görüntüleyebilirsiniz.`)], components: [Rows, RowsTWO]}).then(async (msg) => {
