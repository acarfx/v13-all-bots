...
module.exports = {
  ...
  onRequest: async function (client, message, args) {
    ...
    if(!roller.kurucuRolleri.some(oku => message.member.roles.cache.has(oku)) && !message.member.permissions.has('ADMINISTRATOR') && !ayarlar.staff.includes(message.member.id)) Beklet.add(message.author.id);
        setTimeout(() => {
