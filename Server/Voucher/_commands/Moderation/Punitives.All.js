...
module.exports = {
 ...
 .setStyle('DANGER');
    ...
    const button2 = new MessageButton()
      ...
      let embed = new genEmbed().setColor("WHITE").setFooter(`${ayarlar.serverName ? ayarlar.serverName : message.guild.name} • ${currentPage} / ${pages.length}`, message.guild.iconURL({dynamic: true}))
