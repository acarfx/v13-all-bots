...
module.exports = {
  ...
  onRequest: async function (client, message, args) {
    ...
    message.channel.send({embeds: [embed.setDescription(`Sunucuda taglı olup rolü olmayan \`${rolsuzuye.size}\` üyeye taglı rolü verildi, ve tagsız \`${rollütagsiz.size}\` üyeden geri alınmaya başlandı!`).setFooter('bu işlem biraz zaman alabilir.')]}).then(x => setTimeout(() => {
        x.delete()
    }, 7500));
