...
module.exports = {
  ...
  onRequest: async function (client, message, args) {
    ...
    message.channel.send({embeds: [new genEmbed().setFooter(`${message.member.user.tag} tarafından istendi.`).setDescription(`Aşağıda ${uye} isimli üyenin yöneticiler tarafından eklenmiş notları listelenmektedir.\n\n${Notlar}`)]}).then(async (msg) => {
    })
